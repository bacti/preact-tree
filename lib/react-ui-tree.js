...
export default class UITree extends Component
{
    ...
    {
        !this.updated ? this.Init() : (this.updated = false)
    }
    ...
    Init()
    {
        ...
        const uitree = new Tree(tree)
        uitree.isNodeCollapsed = isNodeCollapsed
        uitree.renderNode = renderNode
        uitree.changeNodeCollapsed = changeNodeCollapsed
        uitree.UpdateNodesPosition()
        this.setState(
        {
            tree: uitree,
            dragging:
    ...
    render({ paddingLeft }, { tree, dragging })
    {
        return (
